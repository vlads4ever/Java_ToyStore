...
//        System.out.println(service.addNewProcurement(1, "Космос", 6));
//        System.out.println(service.showAvailableToys());
//        System.out.println(service.showToyInfo(0));
//        System.out.println(service.showToyInfo(1));
//
//        System.out.println(service.saveStore("Toy.json"));
        System.out.println(service.loadStore("Toy.json"));
        System.out.println(service.showAvailableToys());
